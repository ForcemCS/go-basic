...
// 1. 定义发送的消息（类似于定义 struct）
type HelloRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Name          string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"` // 这里的 1 是编号，不是值
...
const file_proto_hello_proto_rawDesc = "" +
	...
	"\aGreeter\x125\n" +
	"\bSayHello\x12\x13.hello.HelloRequest\x1a\x14.hello.HelloResponseB\x11Z\x0fmy-grpc-demo/pbb\x06proto3"
